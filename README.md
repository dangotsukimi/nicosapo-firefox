...
### 1. 公式ストアからインストール（推奨）
Firefoxのアドオンストアから直接インストールしてご利用いただけます。

* **[ニコ生自動入場 (Auto Enter) - Firefox用アドオン](https://addons.mozilla.org/ja/firefox/addon/%E3%83%8B%E3%82%B3%E7%94%9F%E8%87%AA%E5%8B%95%E5%85%A5%E5%A0%B4-auto-enter/)**

### 2. 手動でインストール（開発者モード）
ソースコードから直接実行したい場合は、以下の手順でインストールできます。
